...
function Section1() {
  return (
    <div className="w-full h-full flex py-10 my-20 items-center justify-between max-md:flex-col-reverse  px-10 max-md:px-4 max-md:pb-20">
      ...
      <div className="right">
        <div
          className="w-[300px] h-[440px] border-3 border-gray-400 rounded-bl-full rounded-tr-full p-4 flex-col justify-center items-center  shadow-lg shadow-gray-600"
          style={{
            ...
            {[
              {
                ...
                viewBox: "0 0 448 512",
                src: "https://github.com/UMANG-2003",
                title: "LinkedIn",
              },
              {
              ...
              return (
                <a
                  ...
                  key={index}
                >
                  <span className="socialIcon [&>svg]:h-5 [&>svg]:w-5 border-3 border-gray-800 rounded-full p-2 cursor-pointer hover:text-white transition duration-300 mx-2 hover:bg-violet-400 shadow-2xl hover:shadow-white">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="currentColor"
